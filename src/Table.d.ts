...
export declare const Table: React.ForwardRefExoticComponent<
            ...
            [
                                      ...
                                      import('@virtuoso.dev/urx').SystemSpec<
                                        ...
                                        () => {
                                          scrollContainerState: import('@virtuoso.dev/urx').Stream<
                                            import('./interfaces').ScrollContainerState
                                          >
                                          scrollTop: import('@virtuoso.dev/urx').Stream<number>
                                          viewportHeight: import('@virtuoso.dev/urx').Stream<number>
                                          headerHeight: import('@virtuoso.dev/urx').StatefulStream<number>
              ...
              import('@virtuoso.dev/urx').SystemSpec<
                ...
                () => {
                  ...
                  TableComponent: import('@virtuoso.dev/urx').StatefulStream<
                    | 'div'
                    | 'table'
                    | 'tbody'
                    | 'thead'
                    ...
                    | undefined
                  >
                  TableHeadComponent: import('@virtuoso.dev/urx').StatefulStream<
                    | 'div'
                    | 'table'
                    | 'tbody'
                    | 'thead'
                    ...
                    | undefined
                  >
                  TableBodyComponent: import('@virtuoso.dev/urx').StatefulStream<
                    | 'div'
                    | 'table'
                    | 'tbody'
                    | 'thead'
                    ...
                    | React.ComponentType<
                        Pick<
                          Pick<
                            ...
                            'key' | keyof React.HTMLAttributes<HTMLTableSectionElement>
                          > & {
                            ref?:
                    ...
                    | undefined
                  >
                  TableRowComponent: import('@virtuoso.dev/urx').StatefulStream<
                    | 'div'
                    | 'table'
                    | 'tbody'
                    | 'thead'
                  ...
                  ScrollSeekPlaceholder: import('@virtuoso.dev/urx').StatefulStream<
                    ...
                    | undefined
                  >
                  FillerRow: import('@virtuoso.dev/urx').StatefulStream<
                    | 'div'
                    | 'table'
                    | 'tbody'
                    | 'thead'
                    | 'tr'
                    | React.ComponentType<
                        import('./interfaces').FillerRowProps & {
                          context?: unknown
                        }
                      >
                    | null
  ...
  >(
    ...
    value: {
      ...
      fixedItemHeight: import('@virtuoso.dev/urx').StatefulStream<number | undefined>
      defaultItemHeight: import('@virtuoso.dev/urx').StatefulStream<number | undefined>
    }[K_3] extends import('@virtuoso.dev/urx').Stream<infer R_4>
      ? R_4
      : never
  ) => void,
  useEmitterValue: <
  ...
  useEmitter: <
    ...
    V_1 = {
      ...
      fixedItemHeight: import('@virtuoso.dev/urx').StatefulStream<number | undefined>
      defaultItemHeight: import('@virtuoso.dev/urx').StatefulStream<number | undefined>
    }[K_5] extends import('@virtuoso.dev/urx').Stream<infer R_6>
      ? R_6
      : never
  >(
    key: K_5,
