...
export declare const Virtuoso: <ItemData extends unknown = any, Context extends unknown = any>(
  props: VirtuosoProps<ItemData, Context> & {
    ref?: Ref<VirtuosoHandle> | undefined
  }
) => ReactElement
export declare const GroupedVirtuoso: <ItemData extends unknown = any, Context extends unknown = any>(
  props: GroupedVirtuosoProps<ItemData, Context> & {
    ref?: Ref<GroupedVirtuosoHandle> | undefined
  }
) => ReactElement
export declare const TableVirtuoso: <ItemData extends unknown = any, Context extends unknown = any>(
  props: TableVirtuosoProps<ItemData, Context> & {
    ref?: Ref<TableVirtuosoHandle> | undefined
  }
) => ReactElement
export declare const VirtuosoGrid: <Context extends unknown = any>(
  props: VirtuosoGridProps<Context> & {
