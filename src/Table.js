...
const tableComponentPropsSystem = system(() => {
  const itemContent = statefulStream((index) => React.createElement('td', null, 'Item $', index))
...
const DefaultScrollSeekPlaceholder = ({ height }) => React.createElement('tr', null, React.createElement('td', { style: { height } }))
const DefaultFillerRow = ({ height }) =>
  React.createElement('tr', null, React.createElement('td', { style: { height: height, padding: 0, border: 0 } }))
