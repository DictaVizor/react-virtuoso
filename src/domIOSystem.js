...
export const domIOSystem = u.system(() => {
    ...
    u.connect(u.pipe(scrollContainerState, u.map(({ scrollTop }) => scrollTop)), scrollTop);
    u.connect(u.pipe(scrollContainerState, u.map(({ scrollHeight }) => scrollHeight)), scrollHeight);
